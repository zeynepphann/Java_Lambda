...
//Lambda Expression...
    ...
    public static void minBul(List<Integer> sayi) {
        ...
        Optional<Integer> minSayiZeynep = sayi.stream().reduce(Lambda02::byZeynepMin);
    }

    public static int byZeynepMin(int a, int b) { // bu method kendisine verilen iki int degerin en kucugunu kendisine verir
    ...
    public static void besbykTk(List<Integer> sayi) {
        sayi.stream().filter(t -> t > 5 && t % 2 == 1).reduce(Lambda02::byZeynepMin);
    }
    ...
    public static void ciftKareKbPrint(List<Integer> sayi) {
        sayi.
                ...
                sorted(). //karesi alinan sayilar dogal siralandi
                forEach(Lambda01::yazdir);
    }
    // Task : list'in tek  elemanlarinin kareleri ni buykten kucuge  print edi

    public static void tekKareKbPrint(List<Integer> sayi) {
        sayi.
                stream().// akis
                filter(t -> (t & 2) == 1).
                map(t -> t * t).//karesi alindi
                sorted(Comparator.reverseOrder()). //karesi alinan sayilar dogal siralandi
                forEach(Lambda01::yazdir);
    }
}
